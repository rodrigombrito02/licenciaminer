...
export const NAV_SECTIONS: NavSection[] = [
  ...
  // ── Produtos Comerciais (cada uma e um link direto, exceto SQ Ambiental)
  {
    label: "SQ Ambiental",
    color: "text-brand-teal",
    group: "produtos",
    items: [
      { href: "/ambiental", label: "Visão geral", icon: Eye },
      { href: "/ambiental/diligencia", label: "Diligência Summo", icon: FileSearch },
      { href: "/due-diligence/templates", label: "Régua-Mestre — requisitos", icon: Ruler },
      { href: "/due-diligence/instancias", label: "Minhas diligências", icon: ClipboardList },
      { href: "/due-diligence/templates?objeto=anuencia&codigo=IPHAN", label: "Anuências — IPHAN", icon: Landmark },
      { href: "/due-diligence/templates?objeto=anuencia&codigo=ESPELEOLOGIA", label: "Espeleologia / Cavidades", icon: Mountain },
      { href: "/due-diligence/templates?objeto=licenca_ambiental&codigo=ANM_LAVRA", label: "Requerimentos ANM", icon: Pickaxe },
      { href: "/due-diligence/templates?objeto=regularizacao_fundiaria", label: "Regularização Fundiária", icon: LandPlot },
      { href: "/viabilidade", label: "Índice de Sucesso", icon: Gauge },
      { href: "/condicionantes", label: "Radar de Condicionantes", icon: Radar },
    ],
  },
  {
    label: "",
